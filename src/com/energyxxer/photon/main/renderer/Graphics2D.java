...
public class Graphics2D {
    ...
    public Graphics2D(java.awt.Graphics2D g, Renderer renderer) {
    ...
    public void fill3DRect(double x, double y, double z, double width, double height) {
    ...
    * */
     ...
     * use <code>setColor</code> followed by <code>fill3DRect</code> to
